...
public class ProfileDatabase {
    ...
    public static void uploadImageToDatabase(Uri data, Context activity, String uid) {
    ...
    private static void saveUriToDatabase(String userDp, ProgressDialog mProgressDialog, Context activity, String uid) {
        FirebaseFirestore
                .getInstance()
                .collection("users")
                .document(uid)
